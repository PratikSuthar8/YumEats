			...
			<div className="flex flex-col lg:flex-row justify-center">
				<div className="flex justify-center md:justify-center">
					<button
						...
						className="m-1 bg-orange-700 border-2 border-orange-700 text-white hover:bg-white hover:text-orange-700 hover:border-orange-700"
					>
						All
					</button>
					<button
					...
					return (
						...
						>
							...
							<div className="flex justify-between py-4 px-2">
								...
								<p className="bg-orange-700 rounded-full -mt-10 text-white p-2  border-8 font-bold">
									{item.price}
								</p>
							</div>
